...
export const people = [
  ...
  { handle: 'joana_be', displayName: 'Joana Ribeiro', bio: 'Platform engineer. I turn "it works on my machine" into a Dockerfile.', location: 'Lisbon, Portugal' },
  { handle: 'ravi_sre', displayName: 'Ravi Subramaniam', bio: 'SRE. On-call is a lifestyle, not a rotation.', location: 'Kuala Lumpur, Malaysia' },
  { handle: 'noor_ios', displayName: 'Noor Al-Sayed', bio: 'iOS dev. SwiftUI convert, still bitter about the UIKit migrations.', location: 'Cairo, Egypt' },
  { handle: 'tomasz_db', displayName: 'Tomasz Kowal', bio: 'Database admin. Every slow query has a story and I want to hear it.', location: 'Warsaw, Poland' },
  { handle: 'lena_oss', displayName: 'Lena Berg', bio: 'Open-source maintainer. My inbox is a museum of good intentions.', location: 'Vienna, Austria' },
  { handle: 'kofi_a11y', displayName: 'Kofi Mensah', bio: 'Accessibility consultant. A screen reader is a code review tool.', location: 'Kigali, Rwanda' },
  { handle: 'mia_vr', displayName: 'Mia Thackeray', bio: 'AR/VR dev. Motion sickness is a design constraint, not a bug.', location: 'Auckland, New Zealand' },
  { handle: 'dario_embed', displayName: 'Dario Conti', bio: 'Embedded systems. My debugger is an oscilloscope.', location: 'Buenos Aires, Argentina' },
  { handle: 'yuki_i18n', displayName: 'Yuki Tanaka', bio: 'Localisation engineer. Pluralisation rules ruined my week again.', location: 'Tokyo, Japan' },
  { handle: 'sofia_devrel', displayName: 'Sofia Almeida', bio: 'Developer advocate. I read the docs so you do not have to, then write better ones.', location: 'Montevideo, Uruguay' },
  { handle: 'lior_cto', displayName: 'Lior Ben-David', bio: 'Founder & CTO. I write less code and more Slack messages than I would like.', location: 'Tel Aviv, Israel' },
  { handle: 'annika_bio', displayName: 'Annika Solberg', bio: 'Bioinformatics dev. Genomes are just very long strings with opinions.', location: 'Oslo, Norway' },
  { handle: 'petro_robo', displayName: 'Petro Kovalenko', bio: 'Robotics dev. ROS launch files are my villain origin story.', location: 'Kyiv, Ukraine' },
  { handle: 'aino_fin', displayName: 'Aino Virtanen', bio: 'Fintech compliance engineer. Yes, I actually read the regulation.', location: 'Helsinki, Finland' },
  { handle: 'thabo_edtech', displayName: 'Thabo Nkosi', bio: 'Ex-teacher turned edtech dev. Grading code review comments like essays.', location: 'Cape Town, South Africa' },
  { handle: 'ines_sys', displayName: 'Inês Pereira', bio: 'Sysadmin. Cron is older than most of my coworkers and still wins.', location: 'Bristol, UK' },
  { handle: 'budi_growth', displayName: 'Budi Santoso', bio: 'Growth engineer. A/B tested the A/B test dialog once. Not proud.', location: 'Jakarta, Indonesia' },
  { handle: 'camila_pm', displayName: 'Camila Duarte', bio: 'Technical PM. My job is translating between two rooms that both think they are speaking English.', location: 'Vancouver, Canada' },
  { handle: 'oscar_motion', displayName: 'Oscar Lindqvist', bio: 'Motion designer. Easing curves are my whole personality.', location: 'Gothenburg, Sweden' },
  { handle: 'wangui', displayName: 'Wangui Kariuki', bio: 'Fullstack dev, second Nairobi export in this feed. We do not all know each other.', location: 'Nairobi, Kenya' },
];
